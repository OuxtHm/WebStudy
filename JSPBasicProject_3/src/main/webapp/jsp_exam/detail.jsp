...
<body>
	...
	<table class="table" width=700>
		<tbody>
			<tr>
				<td align=center width=30% rowspan=9><img
					src="<%=vo.getPoster()%>" style="width: 100%"></td>
			...
			<tr>
				<td aligin=center>
					<%-- <div id="map" style="width: 100%; height: 350px;"></div> <script
						...
						src="//dapi.kakao.com/v2/maps/sdk.js?appkey=6ae49e824de560c4d4a79bf5be38eee9&libraries=services"></script>
					<script>
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=6ae49e824de560c4d4a79bf5be38eee9&libraries=services"></script>
<script>
// 마커를 담을 배열입니다
var markers = [];
