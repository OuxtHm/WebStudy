		...
		<div class="row">
			...
			<form method="post" action="update_ok.jsp">
				<table class="table">
					...
					<tr>
						<th width=15%>제목</th>
						<td width=85%><input type=text name=subject size=20 class="input-sm" required value="<%=vo.getSubject() %>"></td>
					</tr>
					<tr>
						<th width=15%>내용</th>
						<td width=85%>
					...
					<tr>
						<th width=15%>비밀번호</th>
						<td width=85%><input type="password" name=pwd size=20 class="input-sm" required>
							</td>
					</tr>
					<tr>
