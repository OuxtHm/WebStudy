		...
		<div class="row">
			...
			<caption>내장 객체는 서블릿 변환 -> 자동으로 생성되는 객체</caption>
				...
				<tr>
					...
					<td>클라이언트가 보낸 요청 데이터를 모아 전송(파라미터, 쿠키, 세션)</td>
					<td>
						<ul>
				...
				<tr>
					<td>response</td>
					<td>HttpsServletResponse</td>
					<td>
						서버에서 클라이언트 응답할 때 사용<br>
						HTML/COOKIE -> 한 개 JSP 안에서 두 가지를 동시에 보낼 수 없다<br>
