...
<%--
	...
	: 모든 JSP에서 사용이 가능(공유)
	: 사용처 : 로그인 시에 사용자 정보 저장
	-> 동작
		1. 사용자가 JSP에서 청므 접근시 -> 서버는 새로운 세션을 생성
			-> 사용자(브라우저)마다 1개 생성
	...
	-> 주요 메소드
		...
		removeAttribute(String key) : 특정 세션에 저장된 값 한 개 삭제
		invalidate() : 모든 세션을 해제 -> logout
		isNew() : 새로 생성된 세션여부 확인 -> 장바구니	
