...
<body>
	<div class="container">
		...
		<div class="row">
			<table class="table">
				<tr>
					<td width=30p% class="text-center" rowspan=9>
		...
		<div class="row">
			...
			<table class="table">
				<tr>
					...
					%>
						...
						<tr>
					<td class="text-left"><%=vo.getName() %>(<%=rvo.getDbday() %>)</td>
					...
					%>
							...
							<a href="reply-delete.jsp?rno=<%=rvo.getRno() %>&fno=<%=fno %>" class="btn btn-xs btn-success">삭제</a>
					<%
						}
					%>
				...
				<tr>
					<td colspan="2"></td>
					<pre style="white-space: pre-wrap; border: none; background-cololr: white"><%=rvo.getMsg() %></pre>
				</tr>
					</td>
				</tr>
			</table>
			<!-- <table class="table">
				...
				<tr>
					<td colspan="2"></td>
					<pre style="white-space: nowrap; border: none; background-cololr: white"></pre>
				</tr>
			</table> -->
				<%	
						}
						...
						<tr>
							<td>
								<form method="post" action="reply_insert.jsp">
									...
									<input type="submit" value="댓글쓰기" class="btn-primary" style="float: left; height: 88px">
								</form>
							</td>
						</tr>
					</table>
