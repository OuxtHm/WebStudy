...
<%--
	JavaScript
		...
		| ReactJS : redux / tabStack-Query / nextJS
		-------------------------------------------
	자바 스크립트
	1) 정의 : 웹 브라우저에서 동작하는 스크립트 언어
								---------- 단순한 언어
	2) 용도 : 동적 웹 페이지 제작, 서버 개발(NodeJS), 앱 개발
	3) 실행 환경 : 브라우저
	4) 특징 : 인터프리터 언어, 객체 기반, 이벤트 중심
	
	1. 기본 문법
		변수 : 1개의 데이터를 저장하는 메모리 공간
				데이터형이 없다 : 저장되는 데이터를 통해서 자동인식
				var a=10 -> a : int
				var b=10.5 -> b:double	
							----------- number
			...
			-> 형변환
				...
				자바스크립트 ================== 자바 ================== 오라클
					...
					--------------------------------------------------
										| 연결이 안된다
					- 사용법
						외부 자바스크립트 : 여러 개의 파일에서 공통으로 사용
							-> 자바스크립트 파일 생성(.js)
								- .js  .jsx  .tx  .tsx
						<script type="text/javascript" src="파일명">
						내부 자바스크립트 : 한 개의 파이에서 사용
							<head>
								<script>
									-> 설정
								</script>
