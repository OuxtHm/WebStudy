...
<%--
	객체 모델
	------- 태그를 제어 -> 태그를 찾는 방법 
			HTML은 태그를 클래스로 인식 / 속성을 멤버 변수
	1. 태그 id 속성이 있는 경우
		document.getElementById("id명") -> $('#id명')
		<button id="btn">
	2. 태그 class 속성이 있는 경우
		document.getElementByClass("class명") -> $('.class명')
		<button class="btns">
	3. 태그 name 속성이 있는 경우
		document.getElementByName("name명") 
		<intput type=text name="id">
	4. 태그명
...
<body>
	<div class="container">
		<div class="row">
			...
			<table class="table">
				<tr>
					<th width="35%" class="text-center">국어점수</th>
					<td width="65%">
						<input type="text" class="input-sm" id="kor" size=15>
					</td>
				</tr>
				<tr>
					<th width="35%" class="text-center">영어점수</th>
					<td width="65%">
						<input type="text" class="input-sm" id="eng" size=15>
					</td>
				</tr>
				<tr>
					<th width="35%" class="text-center">수학점수</th>
					<td width="65%">
