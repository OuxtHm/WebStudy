	...
	JDBC
		...
		2. 오라클 연결
			Connection conn = DriverManager.getConnection(URL, username, password);
							  -------------- 해당 드라이버를 연결
							  -> 오라클 : oracle.jdbc.driver.OralceDriver
							  -> MySQL : com.mysql.jc.jdbc.Driver
		3. 오라클로 SQL 문장 전송
			Statement
		...
		4. 결과값
			...
			------------------------------------------------------------------------------
		next|	aaa	(1)			홍길동(2)				남자(3)		20(4)		20/01/01(5)
				getString(1)	getString(2)	getString(3)	getInt(4) 	getDate(5)
																			|TO_CHAR
																			|getString()
																-> getDouble(4)
			------------------------------------------------------------------------------
